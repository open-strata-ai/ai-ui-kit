...
This ADR solidifies "OQ-3: How deep is the coupling of streaming rendering based on Vercel AI SDK?" into an architectural decision record and is included in `design/adr/` for continuous tracking. This issue stems from the `design/DESIGN.md` §10 open issue and is still open.
