...
This ADR solidifies "OQ-5: Is the library version strictly synchronized with the platform v1.0.0, or is it independent of SemVer?" into an architectural decision record and included in `design/adr/` for continuous tracking. This issue stems from the `design/DESIGN.md` §10 open issue and is still open.
