...
This ADR solidifies "OQ-2: For the base UI, should I choose antd or shadcn/ui from the §4.1.2 table?" into an architectural decision record and included in `docs/adr/` for continuous tracking. This issue stems from the `docs/DESIGN.md` §10 open issue and is still open.
