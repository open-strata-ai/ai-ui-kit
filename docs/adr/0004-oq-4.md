...
This ADR will solidify "OQ-4: Mermaid's rendering and hydration strategy under SSR (Next.js, §101 front-end uses Next.js)?" into an architectural decision record and include it in `docs/adr/` for continuous tracking. This issue stems from the `docs/DESIGN.md` §10 open issue and is still open.
