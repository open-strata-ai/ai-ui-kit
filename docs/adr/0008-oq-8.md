...
This ADR solidifies "OQ-8: React 19 compatibility and antd v6 upgrade route into v1.4.x planning?" into an architectural decision record and includes it in `docs/adr/` for continuous tracking. This issue stems from the `docs/DESIGN.md` §10 open issue and is still open.
